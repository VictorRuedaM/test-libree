...
import FormModal from 'containers/transferMenu/FormModal';
...
function App() {
  ...
  return (
    <>
          ...
          <Route path="/daos/:network/:dao">
            <Route element={<DaoWrapper />}>
              ...
              <Route element={<ProtectedRoute />}>
                ...
                />
                {/* test-transfer - form component */}
                <Route path="finance/test-transfer" element={<FormModal />} />
                <Route
      ...
      <DaoSelectMenu />
      {/* Route control to render WalletMenu only with non test-transfer routes */}
      {(
...
const DaoWrapper: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        {/* If the path is test-transfer, the Formodal component is rendered */}
        {pathname.split('/')[pathname.split('/').length - 1] ===
        'test-transfer' ? (
